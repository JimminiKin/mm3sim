...
pub struct AllMarbleRuns {
    pub runs: Vec<MarbleRun>,
    pub next_index: usize,
    /// One-frame override: forces all CollapsingHeaders open (true) or closed (false).
...
impl AllMarbleRuns {
    ...
    pub fn get_run_mut(&mut self, idx: usize) -> Option<&mut MarbleRun> {
